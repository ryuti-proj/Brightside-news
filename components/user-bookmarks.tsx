...
export function UserBookmarks() {
  ...
  const filteredBookmarks = useMemo(() => {
    return savedStories.filter((bookmark) => {
      ...
      const matchesSearch =
        title.includes(search) || category.includes(search) || source.includes(search)
    ...
    return (
      <div className="p-6 space-y-6">
        ...
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-600 dark:text-gray-300 mb-2">Loading saved stories...</h3>
        </div>
      </div>
    )
  }
            ...
            >
              ...
              <CardContent className="p-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 mb-3 line-clamp-2 break-words">
                  {bookmark.summary || "Saved to your BrightSide collection."}
                </p>

                <div className="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
                  <span className="truncate mr-2">{bookmark.source || "BrightSide News"}</span>
